...
func (_m *Indexer) ByIndex(indexName string, indexedValue string) ([]interface{}, error) {
...
// GetIndexers provides a mock function with no fields
...
func (_m *Indexer) IndexKeys(indexName string, indexedValue string) ([]string, error) {
	ret := _m.Called(indexName, indexedValue)
