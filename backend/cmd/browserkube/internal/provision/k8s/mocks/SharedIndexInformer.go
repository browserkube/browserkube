...
func (_m *SharedIndexInformer) AddEventHandlerWithOptions(handler cache.ResourceEventHandler, options cache.HandlerOptions) (cache.ResourceEventHandlerRegistration, error) {
...
// GetController provides a mock function with no fields
...
// GetIndexer provides a mock function with no fields
...
// LastSyncResourceVersion provides a mock function with no fields
...
// RunWithContext provides a mock function with given fields: ctx
func (_m *SharedIndexInformer) RunWithContext(ctx context.Context) {
	_m.Called(ctx)
}
...
// SetWatchErrorHandlerWithContext provides a mock function with given fields: handler
func (_m *SharedIndexInformer) SetWatchErrorHandlerWithContext(handler cache.WatchErrorHandlerWithContext) error {
	ret := _m.Called(handler)

	if len(ret) == 0 {
		panic("no return value specified for SetWatchErrorHandlerWithContext")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(cache.WatchErrorHandlerWithContext) error); ok {
		r0 = rf(handler)
	} else {
		r0 = ret.Error(0)
	}
