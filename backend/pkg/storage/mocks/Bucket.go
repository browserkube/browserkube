...
func (_m *Bucket) Copy(ctx context.Context, dstKey string, srcKey string, opts *driver.CopyOptions) error {
...
func (_m *Bucket) ErrorAs(_a0 error, _a1 interface{}) bool {
	...
	if len(ret) == 0 {
		panic("no return value specified for ErrorAs")
	}
...
func (_m *Bucket) NewRangeReader(ctx context.Context, key string, offset int64, length int64, opts *driver.ReaderOptions) (driver.Reader, error) {
...
func (_m *Bucket) NewTypedWriter(ctx context.Context, key string, contentType string, opts *driver.WriterOptions) (driver.Writer, error) {
	ret := _m.Called(ctx, key, contentType, opts)

	if len(ret) == 0 {
		panic("no return value specified for NewTypedWriter")
	}
