module github.com/browserkube/browserkube/session-archiver
...
replace github.com/browserkube/browserkube/operator => ../../operator

replace github.com/browserkube/browserkube/storage => ../../common/storage
