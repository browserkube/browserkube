...
const (
	probeConfigMapName = "probe-config"
)
...
var _ = BeforeSuite(func() {
	...
	err = browserkubeapiv1.AddToScheme(scheme.Scheme)
	Expect(err).NotTo(HaveOccurred())
	...
	/*
	   ...
	   You may notice that the code below runs your controller with nearly identical logic to your CronJob project’s recorder.go!
